...
const ProfileModal = ({ isVisible, onClose, publicProfile }) => {
				...
				<div className='w-[350px] flex flex-col'>
					...
					<div className='bg-gray-900 p-2 rounded-xl h-[350px]'>
						...
						<div className="flex items-center ml-5 mt-5">
							<div className={`avatar ${publicProfile.availability}`}>
								<div className="w-20 rounded-full">
									<img src={publicProfile.photoURL} alt="User Avatar" />
								</div>
							</div>
							<div className="ml-2 mr-10 p-3">
								...
								<p className='text-orange-300'>@{publicProfile.handle}</p>
							</div>
						</div>
						...
						<div className='bg-gray-700 h-[150px] rounded-xl mt-5 ml-5 mr-5'>
							<div className="ml-5 mt-5 mr-5 pt-5">
								...
								>{new Date(publicProfile.createdOn).toLocaleDateString('en-US')}</p>
							</div>
					...
					<div className='bg-gray-900 p-2 rounded-xl h-[350px]'>
						...
						<div className='bg-gray-700 h-[150px] rounded-xl mt-5 ml-5 mr-5'>
							<div className="ml-5 mt-5 mr-5 pt-5">
								...
								>Chatter member since:</p>
								<p className="text-sm text-white"
								>{new Date(userData.createdOn).toLocaleDateString('en-US')}</p>
							</div>
							<div className="border-b border-gray-700 mt-3 mr-5"></div>
							<div className="mt-2 ml-5 mr-5">
								<p className="text-md font-bold text-white"
