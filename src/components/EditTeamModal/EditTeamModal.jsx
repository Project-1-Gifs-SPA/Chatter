...
import { findTeamByName, updateTeamName } from "../../services/teams.service";
            ...
            <div className="flex-col ml-10 pr-0 align-top " >
              <div className="form-control pl-7 ml-10">
                ...
                <div>
                  ...
                  <button className="btn btn-sm border-none bg-red-500 text-white px-4 py-2 ml-3 rounded-md transition-colors duration-300 hover:bg-red-600 "
