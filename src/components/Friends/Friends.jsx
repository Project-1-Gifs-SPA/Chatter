  ...
  return (
    <div className='flex items-center m-4'>
      ...
      <div className='ml-auto'>
        <div className='cursor-pointer tooltip tooltip-top ml-5' data-tip='Send message'
...

        {
          currentUser.friends && <div className='tooltip tooltip-top' data-tip='Remove friend'>
            <MdPersonAddDisabled className='ml-5 cursor-pointer text-white text-xl hidden sm:flex'
              onClick={() => handleRemoveFriends(currentFriend.handle)}
            />
          </div>
        }
      </div>
